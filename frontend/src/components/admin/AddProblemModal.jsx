...
function AddProblemModal({ 
  ...
  const createProblem = async () => {
    ...
    try {
      ...
      const response = await axios.post(`${authUrl}/admin/problems`, problemData, {
        headers: {
    ...
    "output": "expected_result"
        ...
        <div className="bg-gray-750 px-6 py-4 border-t border-gray-700 flex justify-end gap-3">
          ...
          <button
            ...
            className="bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 disabled:from-gray-600 disabled:to-gray-600 disabled:cursor-not-allowed text-white px-6 py-2 rounded-lg text-sm font-medium transition duration-200 flex items-center"
          >
            <svg className="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 6v6m0 0v6m0-6h6m-6 0H6" />
            </svg>
